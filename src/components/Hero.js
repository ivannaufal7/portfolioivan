            ...
            >
                <div className='row align-items-center g-5 hero mt-1 d-flex justify-content-center'>
                    <div className='col-lg-6 text-start'>
                        ...
                        <a href='https://drive.google.com/file/d/1iL8YiVVKJ2Wq22vuD5e66XMfT-JSFd8s/view?usp=sharing' target="_blank" rel="noopener noreferrer" className='btn btn-lg btn-dark'>Download Resume</a>
                    </div>
